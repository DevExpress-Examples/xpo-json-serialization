<!-- default badges list -->
![](https://img.shields.io/endpoint?url=https://codecentral.devexpress.com/api/v1/VersionRange/148645646/22.1.3%2B)
...
* Add the [JsonConverters.cs](CS/XpoSerialization/JsonConverters.cs) file to your project. 
## Create a Controller
